...
class CogVideoXImageToVideo2DPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = torch.cat([latent_model_input, latent_pose_input], dim=2)
