...
os.environ["WANDB_PROJECT"]="Human4D"
...
from finetune.datasets import I2VDatasetWithResize, T2VDatasetWithResize, CharacterDataset
...
class Trainer:
    ...
    def prepare_trainable_parameters(self):
        ...
        if self.args.gradient_checkpointing:
            if self.args.func_type == "4dfinetune":
    ...
    def train(self) -> None:
        ...
        if resume_from_checkpoint_path is not None:
            ...
            print("success loading from", resume_from_checkpoint_path)
        progress_bar = tqdm(
            ...
            for step, batch in enumerate(self.data_loader):
                ...
                with accelerator.accumulate(models_to_accumulate):
                    ...
                    if self.args.func_type == "2dpretrain":
                        loss = self.compute_loss_2d_pretrain(batch)
                    elif self.args.func_type == "4dfintune":
                        loss = self.compute_loss_4d_finetune(batch)
                    else:
